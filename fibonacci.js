    ...
    function rowOrColumnCheck(checkType, isVertical) {
        ...
        for (var r = 0; r < size; r++) {
            ...
            for (var c = from; c < to; c += increment) {
                if (isVertical) {
    ...
    function checkerCoreLogic(row, col, checkContext, checkType) {

        let row1 = 0, col1 = 0;
        if (checkType == checkTypeEnum.ToRight) {
            col1 = -1;
        } else if (checkType == checkTypeEnum.ToBottom) {
            row1 = -1
        }
